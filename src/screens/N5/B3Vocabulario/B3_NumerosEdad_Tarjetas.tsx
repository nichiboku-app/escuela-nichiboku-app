    ...
    <ScrollView contentContainerStyle={s.container}>
      <View style={s.stack}>
        ...
        <View style={s.section}>
          <Text style={s.title}>Tarjetas — Familia</Text>
          <Text style={s.subtitle}>Practica lectura, escucha y memoria con tarjetas 3D.</Text>
        </View>
        ...
        <View style={[s.section, s.cardHelp]}>
          ...
          {showGuide && (
            <View style={{ marginTop: 10 }}>
              <Text style={s.p}>
                Para hablar de la <Text style={s.bold}>familia de otra persona</Text> usamos formas corteses:
                <Text style={s.bold}> おとうさん / おかあさん / ごりょうしん / ごかぞく</Text>.
                Para <Text style={s.bold}>mi propia familia</Text> usamos formas humildes:
                <Text style={s.bold}> ちち / はは / りょうしん / かぞく</Text>.
              </Text>
              <Text style={s.p}>
                Practica con el patrón <Text style={s.bold}>A は B です</Text>:
                <Text style={s.pMono}> ちちは ごじゅっさい です。/ おとうさんは なんさい ですか。</Text>
              </Text>
              <Text style={s.pSmall}>
                Tip: 1歳＝いっさい, 8歳＝はっさい, 10歳＝じゅっさい, 20歳＝はたち.
              </Text>
            </View>
          )}
        </View>
