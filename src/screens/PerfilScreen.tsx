...
export default function ProfileHeader({
  ...
  return (
    <View style={styles.wrap}>
      {/* Fondo principal (toca para cambiar) */}
      ...
      <View style={styles.card}>
        ...
        <View style={styles.avatarAbs}>
          <View style={styles.avatarOuter}>
            ...
            {/* Botón cámara — valores restaurados */}
        ...
        {/* Botón premium (un poco más arriba) */}
...
const styles = StyleSheet.create({
  ...
  // 👉 Contenedor estrecho para que el separador no empuje nada
  dividerWrap: {
    width: 16,             // ancho fijo (estrecho)
    alignItems: 'center',
    justifyContent: 'center',
    pointerEvents: 'none',
  },
  dividerIcon: {
    width: 8,              // grosor visible del separador
    height: 40,            // alto del separador
  },
