...
const styles = StyleSheet.create({
  ...
  rowWrap: { position: 'relative', flexDirection: 'row', alignItems: 'center', minHeight: Math.max(40, ICON_W + 6) },
  itemIcon: { width: ICON_W, height: ICON_W, marginRight: ICON_GAP, resizeMode: 'contain' },
  itemText: { fontSize: 16, fontWeight: '700' },
  knotRight: { position: 'absolute', right: EDGE_INSET, top: '50%', transform: [{ translateY: -9 }], width: 18, height: 18, resizeMode: 'contain', opacity: 0.95 },
  sepUnder: { height: SEP_HEIGHT, marginTop: 6, marginLeft: ICON_W + ICON_GAP + SEP_LEFT_EXTRA, marginRight: EDGE_INSET + 6, width: SEP_WIDTH_DP, alignSelf: 'flex-start' },
  sepSimple: { height: 2, backgroundColor: '#7a0e14', opacity: 0.9, marginTop: 6, marginLeft: ICON_W + ICON_GAP + SEP_LEFT_EXTRA, marginRight: EDGE_INSET + 6, width: SEP_WIDTH_DP, alignSelf: 'flex-start' },
});
